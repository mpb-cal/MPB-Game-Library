...
class MPBShape;
class MPBNavigationMesh;


const bool USE_LIGHT_VOLUMES = false;
const bool SHADOW_VOLUME_CELLS = false;
...
public:
	...
	static void setNavMesh( MPBNavigationMesh* nm );
	static MPBNavigationMesh* getNavMesh() { return m_navMesh; }
...
private:
	...
	static MPBNavigationMesh*				m_navMesh;
